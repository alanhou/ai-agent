...
def trigger_zapier_webhook(zap_id: str, payload: dict) -> str:
    ...
    Args: zap_id (str): The ID of the Zapier webhook to trigger. payload (dict): The payload to send with the webhook.
    Returns: str: A confirmation message indicating the successful trigger of the webhook.
    """
...
def send_slack_message(channel: str, message: str) -> str:
    ...
    Args: channel (str): The Slack channel to send the message to. message (str): The message to send.
    Returns: str: A confirmation message indicating the successful sending of the message.
    """
...
if not selected_group_name:
    ...
    selected_tool = tool_map.get(selected_tool_name, None)
    
    if not selected_tool:
        print("No relevant tool found within the selected group.")
    else:
        logging.info(f"Selected Tool: {selected_tool.name}")
        ...
        try:
            ...
            print(f"Tool '{selected_tool.name}' Result: {tool_result}")
